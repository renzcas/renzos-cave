// script.js v4 — Gothic Cave Engine + Chamber + Operator Dynasty + Symbolic Engine + InfoEngine
...
function animate() {
    ...
    // Operator Dynasty update
    dynasty.update(dt);

    // Symbolic Engine update
